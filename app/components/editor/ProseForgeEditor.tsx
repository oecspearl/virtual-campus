          ...
          <div className="pf-dialog pf-ai-dialog" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="pf-ai-generate-row">
              ...
              >
                {aiLoading ? (
                  <>
                    <span className="pf-ai-spinner"><span /></span>
                    Enhancing...
                  </>
                ) : aiPreview ? (
                  <>
            ...
            <div className="pf-ai-preview">
              {aiLoading ? (
                <div className="pf-ai-loading">
                  <div className="pf-ai-spinner"><span /></div>
                  <span>AI is enhancing your content...</span>
                </div>
              ) : aiPreview ? (
                <div className="pf-ai-preview-content" dangerouslySetInnerHTML={{ __html: sanitizeHtml(aiPreview) }} />
              ) : (
