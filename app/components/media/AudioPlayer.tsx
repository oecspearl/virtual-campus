    ...
    <div className="w-full bg-white rounded-lg sm:rounded-lg border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="p-4 sm:p-6 bg-gradient-to-r from-purple-50 to-indigo-50">
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <button
            onClick={togglePlay}
            className="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-full flex items-center justify-center shadow-lg transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
