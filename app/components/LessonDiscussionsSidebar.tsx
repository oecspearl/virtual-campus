    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      {loading ? (
        ...
        <div className="text-center py-4">
          ...
          <Link 
            href={`/course/${courseId}/lesson/${lessonId}/discussions`}
            className="inline-flex items-center px-3 py-1.5 text-xs font-medium text-oecs-lime-green bg-oecs-lime-green/10 border border-oecs-lime-green/20 rounded-md hover:bg-oecs-lime-green/20 transition-colors"
          >
            Start Discussion
          </Link>
        </div>
        ...
        <div className="space-y-3">
          {discussions.map((discussion) => (
            <Link
              ...
              className="block p-3 rounded-lg border border-gray-100 hover:border-oecs-lime-green/30 hover:bg-oecs-lime-green/5 transition-colors group"
            >
              <h4 className="text-sm font-medium text-gray-900 group-hover:text-oecs-lime-green transition-colors mb-1 line-clamp-2">
                {discussion.title}
              </h4>
          ...
          {discussions.length >= 3 && (
            <div className="pt-2 border-t border-gray-100">
              <Link 
                href={`/course/${courseId}/lesson/${lessonId}/discussions`}
                className="inline-flex items-center w-full justify-center px-3 py-2 text-sm font-medium text-oecs-lime-green bg-oecs-lime-green/10 border border-oecs-lime-green/20 rounded-md hover:bg-oecs-lime-green/20 transition-colors"
              >
