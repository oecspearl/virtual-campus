-- Run this SQL in your Supabase SQL editor to fix the lesson creation issue
...
-- Step 4: Update existing lessons to have course_id based on their subject's course
UPDATE lessons 
