        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 px-6 py-4 bg-[#0077b5] text-white rounded-lg hover:bg-[#006399] transition font-medium shadow-md hover:shadow-lg"
            >
