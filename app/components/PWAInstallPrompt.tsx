...
export default function PWAInstallPrompt({ className = '' }: PWAInstallPromptProps) {
  ...
  return (
    <div className={`fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 z-[9999] ${className}`}>
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-6 backdrop-blur-md pointer-events-auto">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl cursor-pointer"
              >
                Install
              </button>
              <button
                ...
                className="px-4 py-2 text-gray-600 font-medium rounded-xl hover:bg-gray-100 transition-colors cursor-pointer"
              >
                Not now
              </button>
            </div>
