...
export default function NotificationDropdown({ isOpen, onClose, userId }: NotificationDropdownProps) {
  ...
  return (
    <div
      ref={dropdownRef}
      className="absolute top-full right-0 mt-2 w-96 max-w-[calc(100vw-2rem)] bg-white rounded-lg border border-gray-200 z-50 backdrop-blur-md max-h-[600px] flex flex-col"
    >
      {/* Header */}
