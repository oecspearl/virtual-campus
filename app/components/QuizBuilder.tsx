...
import QuestionEditor, { type Question } from "@/app/components/QuestionEditor";
import Button from "@/app/components/Button";
import AIQuizGenerator from "@/app/components/AIQuizGenerator";
import QuizExtensionManager from "@/app/components/QuizExtensionManager";
...
export default function QuizBuilder({ 
  ...
  React.useEffect(() => {
    if (mode === 'edit' && initialData) {
      ...
      setProctoredMode(initialData.proctored_mode || false);
