        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              <input 
                type="number" 
                className="w-full rounded-lg border-2 border-gray-300 px-4 py-3 text-lg font-semibold focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all" 
                value={grade} 
                onChange={(e) => {
          ...
          <div>
            ...
            <textarea 
              className="w-full rounded-lg border-2 border-gray-300 px-4 py-3 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none" 
              rows={8}
              value={feedback} 
          ...
          <div className="flex items-center gap-4 pt-4 border-t border-gray-200">
            <button 
              type="button" 
              className="flex-1 bg-slate-800 hover:bg-slate-700 px-4 py-2 text-white font-medium rounded-md transition-all shadow-sm hover:shadow flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed" 
              onClick={submitGrade} 
              disabled={loading}
            >
              {loading ? (
