  ...
  switch (item.type) {
    ...
    case "label": {
      ...
      if (style === "banner") {
        ...
        return (
          <div className={`relative overflow-hidden ${paddingClasses[size as keyof typeof paddingClasses]} my-5 rounded-lg bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-lg`}>
