...
const SortableLessonItem: React.FC<SortableLessonItemProps> = ({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group relative bg-gradient-to-r from-white to-gray-50 rounded-lg sm:rounded-xl border border-gray-200 p-4 sm:p-6 transition-all duration-300 ${
        isDragging
      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
        <div className="flex items-start gap-3 sm:gap-4 flex-1">
          ...
          <div className="flex-shrink-0">
            <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center text-white font-bold text-sm sm:text-lg shadow-lg ${
              isReorderMode 
        ...
        <div className="flex items-center gap-2 sm:gap-3 sm:flex-shrink-0">
          <Link 
            ...
            className="inline-flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs sm:text-sm font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
