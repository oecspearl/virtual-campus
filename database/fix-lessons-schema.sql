-- Fix lessons schema to allow direct course-lesson relationship
...
-- Step 3: Add constraint to ensure lessons have either course_id or subject_id (but not necessarily both)
