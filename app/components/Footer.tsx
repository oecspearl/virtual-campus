        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-4 mb-6">
              <div className="relative flex h-14 w-14 items-center justify-center rounded-xl shadow-lg overflow-hidden border border-white/10">
                {/* Textured background */}
            ...
            <div className="flex gap-4">
              {(footerSocialLinks.length > 0 ? footerSocialLinks : [
                ...
                <a
                  key={index}
                  href={link.url}
                  className="w-10 h-10 bg-gray-700 hover:bg-blue-600 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-110"
                >
            ...
            <div className="space-y-4">
              <div suppressHydrationWarning={true}>
                <Input 
                  ...
                  className="w-full px-4 py-3 bg-gray-700 border-gray-600 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent rounded-xl"
                />
              </div>
              <div suppressHydrationWarning={true}>
                <button className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center group">
