...
export default function GoogleMeetConference({
  ...
  // Track leave on tab close or navigation away
  useEffect(() => {
    if (!isJoined) return;
    ...
    const handleVisibilityChange = () => {
      if (document.visibilityState === 'hidden') {
        ...
        // Re-join to clear left_at when tab becomes visible again
        fetch(`/api/conferences/${conference.id}/join`, {
          method: 'POST',
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full mx-4 text-center">
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={isJoining}
            className="w-full bg-green-500 hover:bg-green-600 disabled:bg-green-400 text-white font-medium py-2 px-4 rounded-lg transition-colors flex items-center justify-center space-x-2"
          >
            {isJoining ? (
              <>
