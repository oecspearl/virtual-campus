...
import AITutorPreferences from '@/app/components/ai/AITutorPreferences';
                ...
                <div className="relative w-24 h-24 mx-auto mb-4">
                  ...
                  {uploadingAvatar && (
                    <div className="absolute inset-0 bg-black/50 rounded-full flex items-center justify-center z-20">
                      <LoadingIndicator variant="pulse" size="xs" />
                    </div>
                  )}
                </div>
                <button 
            ...
            <div className="space-y-4">
              {profile.student_id && (
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                  <Icon icon="material-symbols:badge" className="w-5 h-5 text-gray-500" />
                  <div>
                    <div className="text-sm font-medium text-gray-900">Student ID</div>
                    <div className="text-sm text-gray-600">{profile.student_id}</div>
                  </div>
                </div>
              )}
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="profile-avatar" className="block text-sm font-semibold text-gray-700 mb-2">
                      Avatar URL
                    </label>
                    <div className="flex gap-2">
                      <Input
                        ...
                        className="flex-1 px-4 py-3 border border-gray-200 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                      />
                      <button
                        type="button"
                        onClick={handleCameraButtonClick}
              ...
              <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none"
                    rows={4}
                  />
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="profile-learning-style" className="block text-sm font-semibold text-gray-700 mb-2">
                      Learning Style
                    </label>
                    <select
                  ...
                  <div>
                    <label htmlFor="profile-difficulty" className="block text-sm font-semibold text-gray-700 mb-2">
                      Difficulty Level
                    </label>
                    <select
                  ...
                  <div className="md:col-span-2">
                    <label htmlFor="profile-subjects" className="block text-sm font-semibold text-gray-700 mb-2">
                      Subject Interests
                    </label>
                    <Input
                      id="profile-subjects"
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8 border-t border-gray-200">
                <m.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button 
                    onClick={saveProfile} 
                    disabled={saving}
                    className="w-full sm:w-auto bg-slate-800 hover:bg-slate-700 text-white font-medium py-2 px-4 rounded-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {saving ? (
                      <>
                        <span className="inline-flex items-center gap-1">{[0,1,2].map(i=><span key={i} className="w-1 h-1 rounded-full bg-current" style={{animation:`ld 1.4s ease-in-out ${i*0.16}s infinite`}}/>)}</span>
                        <style jsx>{`@keyframes ld{0%,80%,100%{transform:translateY(0)}40%{transform:translateY(-4px)}}`}</style>
                        Saving...
                      </>
                    ) : (
                      <>
                ...
                <m.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  <Button 
                    variant="outline" 
                    onClick={loadProfile}
                    className="w-full sm:w-auto border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-2 px-4 rounded-md transition-all duration-200 flex items-center justify-center gap-2"
                  >
