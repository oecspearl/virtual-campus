...
// Loading placeholder for editors
const EditorSkeleton = () => (
  <div className="w-full border border-gray-200 rounded-lg animate-pulse bg-gray-50" style={{ minHeight: 200 }} />
);

// Dynamically import all editors to reduce initial bundle size
...
export default function TextEditor({
  ...
  if (loading) {
    return (
      <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-8 flex items-center justify-center" style={{ minHeight: `${height}px` }}>
