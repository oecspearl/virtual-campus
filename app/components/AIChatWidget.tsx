  ...
  return (
    <>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed bottom-40 right-4 sm:bottom-24 sm:right-6 lg:bottom-24 z-[1050] w-[calc(100vw-2rem)] sm:w-96 h-[min(600px,calc(100vh-12rem))] bg-white rounded-lg shadow-2xl border border-gray-200 flex flex-col"
