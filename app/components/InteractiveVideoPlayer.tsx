            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {!showFeedback && (
                <button
                  onClick={handleAnswer}
                  disabled={!userAnswer}
                  className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white rounded-lg font-medium transition-colors"
                >
                  Submit Answer
                </button>
              )}
