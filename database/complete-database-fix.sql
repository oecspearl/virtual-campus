-- Complete Database Schema Fix for OECS LearnBoard LMS
-- Run this in Supabase SQL Editor to fix all missing tables

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. Create lesson_progress table (the main missing table causing the error)
...
-- 2. Create course_discussions table
...
-- 3. Create discussion_replies table
...
-- 4. Create discussion_votes table
...
-- 5. Create lesson_discussions table
...
-- 6. Create lesson_discussion_replies table
...
-- 7. Create lesson_discussion_votes table
...
-- 10. Create RLS policies for lesson_progress
...
-- 11. Create RLS policies for course_discussions
...
-- 12. Create RLS policies for discussion_replies
...
-- 13. Create RLS policies for discussion_votes
CREATE POLICY "Authenticated users can vote" ON discussion_votes
    FOR ALL USING (user_id = auth.uid());

-- 14. Create RLS policies for lesson_discussions
...
-- 15. Create RLS policies for lesson_discussion_replies
...
-- 16. Create RLS policies for lesson_discussion_votes
