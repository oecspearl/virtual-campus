-- Migration: 007-fix-v2.sql
-- Safe re-run script for Student Experience Features (Version 2)
-- Handles tables that may have been partially created
...
CREATE INDEX IF NOT EXISTS idx_student_notes_lesson ON student_notes(student_id, lesson_id);
...
CREATE INDEX IF NOT EXISTS idx_student_bookmarks_student ON student_bookmarks(student_id);
CREATE INDEX IF NOT EXISTS idx_student_bookmarks_type ON student_bookmarks(student_id, bookmark_type);
CREATE INDEX IF NOT EXISTS idx_student_bookmarks_folder ON student_bookmarks(student_id, folder);
...
CREATE INDEX IF NOT EXISTS idx_calendar_events_student ON student_calendar_events(student_id);
CREATE INDEX IF NOT EXISTS idx_calendar_events_date ON student_calendar_events(student_id, start_datetime);
CREATE INDEX IF NOT EXISTS idx_calendar_events_source ON student_calendar_events(source_type, source_id);
...
CREATE INDEX IF NOT EXISTS idx_student_todos_student ON student_todos(student_id);
CREATE INDEX IF NOT EXISTS idx_student_todos_status ON student_todos(student_id, status);
CREATE INDEX IF NOT EXISTS idx_student_todos_due ON student_todos(student_id, due_date);
CREATE INDEX IF NOT EXISTS idx_student_todos_course ON student_todos(student_id, course_id);
...
CREATE INDEX IF NOT EXISTS idx_study_group_messages_sender ON study_group_messages(sender_id);
...
CREATE INDEX IF NOT EXISTS idx_study_group_events_group ON study_group_events(group_id);
CREATE INDEX IF NOT EXISTS idx_study_group_events_date ON study_group_events(start_datetime);

-- ================================================================
-- STUDY SESSIONS - DROP AND RECREATE IF EXISTS WITH WRONG SCHEMA
-- ================================================================

DROP TABLE IF EXISTS student_study_sessions CASCADE;
...
CREATE INDEX idx_study_sessions_date ON student_study_sessions(student_id, started_at);
