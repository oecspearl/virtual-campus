        ...
        >
          ...
          {user && (
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2 mx-auto"
            >
              <Icon icon="material-symbols:add" className="w-5 h-5" />
        ...
        <div className="space-y-4">
          {discussions.map((discussion, index) => (
            <motion.div
              ...
              className={`group bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 ${
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Link 
                    ...
                    className="block group-hover:bg-gray-50/50 rounded-xl p-2 -m-2 transition-colors"
                  >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {isGraded && isInstructor && (
          <motion.div
            ...
            className="border-2 border-green-200 bg-green-50 rounded-xl p-6 space-y-5"
          >
