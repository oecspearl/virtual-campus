        ...
        for (const e of enrollments) {
          if (e.courses) {
            ...
            rows.push({
              ...
              course: e.courses,
              progress,
              sectionName: e.classes?.name || null,
            });
          }
        }
        setItems(rows);
        ...
        <div className="mx-auto max-w-8xl px-4 py-8">
          ...
          <div className="mb-8">
            <div className="bg-white rounded-lg border border-gray-100 overflow-hidden">
              <div className="px-8 py-6" style={{ background: 'linear-gradient(to right, var(--theme-primary), var(--theme-secondary))' }}>
                ...
                <p className="mt-2" style={{ color: 'rgba(255, 255, 255, 0.9)' }}>Your learning journey continues here</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center py-20">
            <div className="text-center bg-white rounded-lg border border-gray-100 p-12 max-w-md">
              ...
              <button 
                ...
                className="inline-flex items-center px-4 py-2 bg-slate-800 text-white rounded-lg font-medium hover:from-red-600 hover:to-red-700 transition-all duration-200 shadow-lg "
              >
        ...
        {items.length === 0 ? (
          <div className="flex items-center justify-center py-20">
            <div className="text-center bg-white rounded-lg border border-gray-100 p-12 max-w-md">
              ...
              <Link 
                href="/courses" 
                className="inline-flex items-center px-4 py-2 bg-slate-800 text-white rounded-md font-medium hover:bg-slate-700 transition-all duration-200 shadow-lg "
              >
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
            {items.map((row, idx) => (
              <div key={idx} className="group bg-white rounded-lg border border-gray-100 overflow-hidden transition-all duration-300 hover:shadow-lg">
                {/* Course Image */}
                <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                  {row.course.thumbnail ? (
                    ...
                    <div className="h-full w-full bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 flex items-center justify-center">
                      <svg className="w-16 h-16 text-white group- transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                      </svg>
                    </div>
                  )}
                ...
                {/* Course Content */}
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-[var(--theme-primary)] transition-colors">
                    {row.course.title}
                  </h3>
                  {row.sectionName && (
                    <div className="mb-2">
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-indigo-50 text-indigo-700 text-xs font-medium rounded-md border border-indigo-100">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{ background: 'linear-gradient(to right, var(--theme-primary), var(--theme-secondary))', width: `${row.progress.percentage}%` }}
                      ></div>
                    </div>
                  </div>
                  ...
                  {row.progress.percentage === 100 ? (
                    <Link 
                      ...
                      className="inline-flex items-center justify-center w-full px-4 py-2 bg-slate-800 text-white rounded-md font-medium hover:bg-slate-700 transition-all duration-200 group- transform duration-300"
                    >
                      <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
